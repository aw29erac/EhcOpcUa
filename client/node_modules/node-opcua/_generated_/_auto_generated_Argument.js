 ...
 * @param  [options.dataType] {DataTypeAsNodeId} The data type of the argument.
...
var encode_DataTypeAsNodeId = _defaultTypeMap.DataTypeAsNodeId.encode;
var decode_DataTypeAsNodeId = _defaultTypeMap.DataTypeAsNodeId.decode;
...
Argument.prototype.encode = function(stream,options) {
    ...
    encode_DataTypeAsNodeId(this.dataType,stream);
...
Argument.prototype.decode = function(stream,options) {
    ...
    this.dataType = decode_DataTypeAsNodeId(stream,options);
