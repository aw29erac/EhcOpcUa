...
var EventField= require("./_auto_generated_EventField").EventField;
 ...
 * @param  [options.events] {EventField[]} The list of Events being delivered. This structure is defined in-line with the following indented items.
 */
function EventNotificationList(options)
{
    ...
    if(options.events) {
        ...
        self.events = options.events.map(function(e){ return new EventField(e);});
    }
