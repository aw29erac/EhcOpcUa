// --------- This code has been automatically generated !!! Fri Jul 03 2015 14:02:40 GMT+0200 (CEST)
/**
...
var _enum_properties = {
    ...
    "securityMode": {
        ...
        configurable: false,
            ...
            set: function(value) {
                var coercedValue = _enumerations.EnumMessageSecurityMode.typedEnum.get(value);
                /* istanbul ignore next */
                if ( coercedValue === undefined || coercedValue === null) {
                      throw new Error("value cannot be coerced to EnumMessageSecurityMode: " + value);
                }
 ...
 * @param  [options.securityMode] {EnumMessageSecurityMode} The security mode to use with the channel.
...
var encode_EnumMessageSecurityMode = _enumerations.EnumMessageSecurityMode.encode;
var decode_EnumMessageSecurityMode = _enumerations.EnumMessageSecurityMode.decode;
...
OpenSecureChannelRequest.prototype.encode = function(stream,options) {
   ...
   this.requestHeader.encode(stream,options);
    ...
    encode_EnumMessageSecurityMode(this.securityMode,stream);
...
OpenSecureChannelRequest.prototype.decode = function(stream,options) {
    ...
    this.securityMode = decode_EnumMessageSecurityMode(stream,options);
