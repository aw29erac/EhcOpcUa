 ...
 * @param  [options.namespaceUri = null] {Int32} The symbolicId is defined within the context of a namespace.
 * @param  [options.symbolicId = null] {Int32} The symbolicId shall be used to identify a vendor-specific error or condition
 * @param  [options.locale = null] {Int32} The locale part of the vendor-specific localized text describing the symbolic id.
 * @param  [options.localizedText = null] {Int32} 
 * @param  [options.additionalInfo = null] {String} Vendor-specific diagnostic information.
 * @param  [options.innerStatusCode = null] {StatusCode} The StatusCode from the inner operation.
