 ...
 * @param  [options.availableSequenceNumbers] {Counter[]}  a list of sequence number available in the subscription for retransmission and not acknoledged by the client
...
function PublishResponse(options)
{
    ...
    /**
      *  a list of sequence number available in the subscription for retransmission and not acknoledged by the client
