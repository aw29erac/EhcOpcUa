...
var schema = require("../schemas/EventField_schema").EventField_Schema;
...
util.inherits(EventField,BaseUAObject);
schema.id = generate_new_id();
EventField.prototype.encodingDefaultBinary =makeExpandedNodeId(schema.id);
EventField.prototype._schema = schema;
 ...
 */
EventField.prototype.encode = function(stream,options) {
...
EventField.prototype.decode = function(stream,options) {
    // call base class implementation first
...
EventField.possibleFields = function() {
    return [
        "clientHandle",
         "eventFields"
    ];
...
register_class_definition("EventField",EventField);